...
* CRN 19519 - WEB2 (in Hampton Roads)
* CRN 19520 - WEB5 (in Virginia, but outside of Hampton Roads)
* CRN 19521 - WEB7 (in the US, but outside of Virginia)
* CRN 19526 - WEB8 (outside of the US)

CS 532 (graduate) sections:

* CRN 19522 - WEB2 (in Hampton Roads or in Virginia)
* CRN 19523 - WEB5 (in Virginia, but outside of Hampton Roads)
* CRN 19524 - WEB7 (in the US, but outside of Virginia)
* CRN 19525 - WEB8 (outside of the US)
...
|---|---|---|
|1|Aug 27|Introduction to Web Science and Web Architecture
|2|Sep 3|Introduction to Python
|3|Sep 10|Introduction to Info Vis with R, Python
|4|Sep 17|Measuring the Web
|5|Sep 24|Archiving the Web
|6|Oct 1|Searching the Web
| | Oct 8|**NO CLASS - Fall Break**
|7|Oct 15|Social Networks
|8|Oct 22|Selection and Social Influence
|9|Oct 29|Visualizing Social Networks
|10|Nov 5|Disinformation
|11|Nov 12|Collective Intelligence and Recommender Systems
|12|Nov 19|Clustering Algorithms<br/>**Nov 23-27 - Thanksgiving Break**|
|13|Mon, Nov 28|Document Filtering (Classification)
|14|Dec 2|kNN and Algorithm Summary
