...
**Due:** Sunday, October 17, 2021 by 11:59pm  

**Important:** Q1 requires obtaining a Twitter Developer Account (see [Twitter Setup](fall21/getting-started/twitter-setup.md)).  This may take a day or two, so if you haven't already done this, get started today.
...
Before starting, review the [HW report guidelines](fall21/getting-started/reports.md).  Name your report for this assignment `HW2-report` with the proper file extension.  Do not edit this file (`README.md`).
...
Setup for this task:
* Obtain a Twitter Developer Account (see [Twitter Setup](fall21/getting-started/twitter-setup.md))
* Use the example scripts ([`collect-tweets.py`](fall21/getting-started/collect-tweets.py), [`process-tweets.py`](fall21/getting-started/process-tweets.py)) referenced in [EC 0.7](fall21/getting-started/EC0.7.md) (and copied into this repo) as starter code for your assignment. Modify them as needed.
...
Make sure that you have committed and pushed your local repo to GitHub.  Your repo should contain any code you developed and images needed to answer the questions. Include "Ready to grade @weiglemc @pscheibl" in your final commit message.
...
* Copy/paste the URL of your report into the edit box
  * should be something like https<nolink>://github.com/odu-cs432-websci/fall21-hw2-*username*/blob/master/HW2-report.{pdf,md}
